    ...
    <aside id="sidebar">
      ...
      <div class="sidebar-content">
        <div class="notes">
          <h3>About</h3>
          <p>
            Halaman ini menampilkan integrasi untuk sumber daya yang dipilih.
          </p>
          <a @click="goBack" class="sidebar-link" style="cursor: pointer;">
...
function update(source: NodeData) {
    ...
    nodeEnter
      ...
      if (d.id) {
        ...
        window.location.href = `/integration/${d.id}`
      }
    })
